      ...
      >
        <input
          ...
          className="
            ...
            border border-accent-400/60 backdrop-blur-sm
            bg-white/80 text-gray-800 placeholder-typo-muted
            focus:ring-2 focus:ring-accent-600 focus:border-accent-600
        ...
        <button
          type="submit"
          className="absolute right-12 top-1/2 -translate-y-1/2 text-accent-600 hover:text-accent-700 transition-colors duration-200 p-1"
          aria-label="Search"
        >
          <FontAwesomeIcon
        ...
        {/* Create Button - Only show for todos page */}
        {getCreateLink() && (
          <Link 
            to={getCreateLink()}
            className="absolute right-3 top-1/2 -translate-y-1/2 text-accent-600 hover:text-accent-700 transition-all duration-200 p-1 hover:scale-110"
